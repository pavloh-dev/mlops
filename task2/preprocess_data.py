...
def run_data_prep(raw_data_path: str, dest_path: str, dataset: str = "green"):
    ...
    objects = [dv, (X_train, y_train), (X_val, y_val), (X_test, y_test)]
    filenames = ["dv.pkl", "train.pkl", "val.pkl", "test.pkl"]

    cnt = 0
    for i, (obj, name) in enumerate(zip(objects, filenames), start=1):
        filepath = os.path.join(dest_path, name)
        dump_pickle(obj, filepath)
        cnt += 1
